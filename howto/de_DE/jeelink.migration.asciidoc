...
=== Updates und Überprüfung der Konfiguration
...
HINWEIS : Eine nicht erschöpfende Liste mit Informationen zur Migration ist link:../images/MemoMigration.xls[hier] verfügbar
